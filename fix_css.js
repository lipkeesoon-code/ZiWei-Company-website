...
const cssPath = 'C:/Users/user/Downloads/ZiWei Company website/style.css';
let css = fs.readFileSync(cssPath, 'utf-8');

const regex = /\/\* Chart CSS Ported from Junior \*\/[\s\S]*?\.lr-day-item\.highlight-orange \{/;

const replacement = `/* Chart CSS Ported from Junior */
.top-purple-bar {
    width: 378px;
    height: 40px;
